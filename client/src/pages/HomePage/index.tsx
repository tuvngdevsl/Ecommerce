  ...
  return (
    <>
        ...
        <div className='row'>
          <div className='col-6'>
            <div className='main-banner position-relative'>
              <img src='images/main-banner-1.jpg' alt='Banner' className={cx('img-fluid rounded-3', 'img-banner')} />
          ...
          <div className='col-6'>
            <div className={cx('d-flex flex-wrap justify-content-between align-items-center', 'gap-10')}>
              <div className={cx('small-banner', 'position-relative')}>
                <img src='images/catbanner-01.jpg' alt='Banner' className={cx('img-fluid rounded-3', 'img-banner')} />
              ...
              <div className={cx('small-banner', 'position-relative')}>
                <img src='images/catbanner-02.jpg' alt='Banner' className={cx('img-fluid rounded-3', 'img-banner')} />
                <div className={cx('position-absolute', 'small-banner-content')}>
                  <h4>New Arrival</h4>
                  <h5>Buy Ipad Air</h5>
                  <p>
              ...
              <div className={cx('small-banner', 'position-relative')}>
                <img src='images/catbanner-03.jpg' alt='Banner' className={cx('img-fluid rounded-3', 'img-banner')} />
                <div className={cx('position-absolute', 'small-banner-content')}>
                  <h4>15% Off</h4>
                  <h5>Smartwatch</h5>
                  <p>
              ...
              <div className={cx('small-banner', 'position-relative')}>
                <img src='images/catbanner-04.jpg' alt='Banner' className={cx('img-fluid rounded-3', 'img-banner')} />
                <div className={cx('position-absolute', 'small-banner-content')}>
      ...
      <Container class1='home-wrapper-2 py-5'>
        <div className='row'>
          <div className='col-12'>
            <div className={cx('categories', 'd-flex justify-content-between flex-wrap align-items-center')}>
