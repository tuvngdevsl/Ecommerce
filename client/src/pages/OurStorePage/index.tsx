          ...
          <div className='col-3'>
            ...
            <div className={cx('filter-card', 'mb-3')}>
              ...
              <div>
                ...
                <div className={cx('form-check')}>
                  <input className={cx('form-check-input')} type='checkbox' value='' id='color-1' />
                  <label className={cx('form-check-label')} htmlFor='color-1'>
                    S (2)
                  </label>
                </div>
                <div className={cx('form-check')}>
                  <input className={cx('form-check-input')} type='checkbox' value='' id='color-2' />
            ...
            <div className={cx('filter-card', 'mb-3')}>
              ...
              <div>
                <div className={cx('product-tags', 'd-flex flex-wrap align-items-center gap-10')}>
                  ...
                  <span className='badge bg-light text-secondary rounded-3 py-2 px-3'>PC Gaming</span>
            ...
            <div className={cx('filter-sort-grid', 'mb-4')}>
              <div className='d-flex justify-content-between align-items-center'>
                <div className={cx('d-flex align-items-center', 'gap-10')}>
                  ...
                  <select defaultValue={'manual'} name='' id='' className={cx('form-control form-select')}>
