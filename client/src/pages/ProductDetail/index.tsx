            ...
            <div className='col-6'>
              <div className={cx('main-product-image')}>
                ...
                <div className={cx('other-product-images', 'd-flex flex-wrap gap-15')}>
                  <div>
                    <img
                      src='https://www.leafstudios.in/cdn/shop/products/Main_a66bce90-71a9-4c4f-9469-078ec70933e0_800x.jpg?v=1673960414'
                      alt='watch'
                      className='img-fluid'
                    />
                  </div>
            ...
            <div className='col-6'>
              <div className={cx('main-product-details')}>
                <div className={cx('border-bottom')}>
                  <h3 className={cx('title')}> Kids Headphones Bulk 10 pack ........</h3>
                </div>
                ...
                <div className={cx('border-bottom')}>
                  <div className='d-flex gap-10 align-items-center my-2'>
                    ...
                    <p className={cx('product-data')}>Watch</p>
                  </div>
                  <div className='d-flex gap-10 align-items-center my-2'>
                    <h3 className={cx('product-heading')}>Brand : </h3>
                    <p className={cx('product-data')}>Havels</p>
                  </div>
                  <div className='d-flex gap-10 align-items-center my-2'>
        ...
        <div className='row'>
          <div className='col-12'>
            ...
            <div className='bg-white p-3'>
              <p>
                Lorem, ipsum dolor sit amet consectetur adipisicing elit. Porro ullam temporibus pariatur ipsum error
                animi id unde laboriosam quidem deleniti tempore dicta esse magni provident nemo possimus vitae, saepe
                nihil!
              </p>
            </div>
          </div>
            ...
            <div className={cx('review-inner-wrapper')}>
              ...
              <div className={cx('reviews', 'mt-4')}>
                <div className={cx('reviews')}>
                  ...
                  <p className='mt-3'>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus numquam assumenda iste quibusdam? In
                    neque at explicabo deserunt aut autem saepe dolorum iusto earum repudiandae cumque, id expedita
                    sapiente fugit.
                  </p>
                </div>
              </div>
