            ...
            <div className={cx('d-flex justify-content-between', 'contact-inner-wrapper')}>
              <div className=''>
                ...
                <form action='' className='d-flex flex-column gap-15'>
                  <div>
                    <input type='text' className={cx('form-custom', 'form-control')} placeholder='Name' />
                  </div>
                  <div>
                    <input type='text' className={cx('form-custom', 'form-control')} placeholder='Email' />
                  </div>
                  <div>
                    <input type='text' className={cx('form-custom', 'form-control')} placeholder='Mobile Number' />
                  </div>
                  <div>
                    <textarea
                ...
                <div>
                  <ul className='ps-0'>
                    <li className='fs-5 gap-15 d-flex align-items-center'>
                      <AiOutlineHome />
                      <address className='mb-0'>B6C Nam Trung Yen, Trung Hoa, Cau Giay, Ha Noi</address>
                    </li>
                    <li className='fs-5 gap-15 d-flex align-items-center'>
                      <BiPhoneCall />
